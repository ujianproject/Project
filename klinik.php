...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h2> Tentang Klinik Mekar Sari </h2><br>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      <p><b>kontak yang tertera akan selalu di respon selama 24 jam</b></p>
      <p><span class="glyphicon glyphicon-map-marker " align></span>Pekanbaru</p>
      <p><span class="glyphicon glyphicon-phone "></span>0823-8844-1889</p>
      <p><span class="glyphicon glyphicon-envelope "></span>mekar.sari@gmail.com</p>
    </div>
    <div class="col-sm-7 slideanim">
      ...
      <div class="row">
        <div class="col-sm-12 form-group">
          <button class="btn btn-default pull-right" type="Kirim">Send</button>
        </div>
      </div>
    </div>
  </div>
